...
const lyricChangeReducer = (state = initialState.songsById, action) => {
  ...
  switch (action.type) {
    case "NEXT_LYRIC":
       ...
       newSongByIdEntry = Object.assign({}, state[action.currentSongId], {
         arrayPosition: newArrayPosition
       })
       newSongByIdStateSlice = Object.assign({}, state, {
         [action.currentSongId]: newSongByIdEntry
       });
       return newSongByIdStateSlice;
    case 'RESTART_SONG':
    newSongByIdEntry = Object.assign({}, state[action.currentSongId], {
      arrayPosition: 0
    })
    newSongByIdStateSlice = Object.assign({}, state, { [action.currentSongId]: newSongByIdEntry});
    return newSongByIdStateSlice;
    default:
      return state;
  }
...
expect(lyricChangeReducer(initialState.songsById, {
  type: 'RESTART_SONG', currentSongId: 1})).toEqual({
    1: {
      title: "Bye Bye Bye",
      artist: "N Sync",
      songId: 1,
